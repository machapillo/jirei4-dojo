...
export const extraQuestions: Question[] = [
  // CVP
  {
    ...
    solution: "2222",
    explanation: "(固定費+目標利益)/(価格-変動費)=(1,800,000+200,000)/900≈2,222.2→最も近い整数で2,222個。",
    difficulty: "medium",
    unit: "個",
    rounding: "round",
  },
  ...
  // NPV
  {
    ...
    solution: "124800",
    explanation: "年金現価係数(8%,4)=3.312。PV=400,000×3.312=1,324,800。NPV=1,324,800-1,200,000=124,800。",
    difficulty: "medium",
    unit: "円",
    rounding: "round",
  },
  {
    ...
    solution: "138000",
    explanation: "年金現価係数(7%,5)≈4.100。PV=180,000×4.100=738,000。NPV=738,000-600,000=138,000。",
    difficulty: "hard",
    unit: "円",
    rounding: "round",
  },
  ...
  // 在庫（EOQ）
  {
    ...
    solution: "707",
    explanation: "EOQ=√(2DS/H)=√(2×5000×2500/50)=√(500,000)=707。",
    difficulty: "medium",
    unit: "個",
    rounding: "round",
  },
  {
    ...
    solution: "979",
    explanation: "√(2×12000×1200/30)=√(960,000)=979。",
    difficulty: "easy",
    unit: "個",
    rounding: "round",
  },
  ...
  // 線形計画
  {
    ...
    solution: "49",
    explanation: "候補(0,10),(7,0),(4,6)等。Z(4,6)=46、(7,0)=49が最大。",
    difficulty: "hard",
    rounding: "round",
  },
  {
    ...
    solution: "30",
    explanation: "交点(3,3)でZ=30。端点(4,0)=20,(0,4)=20より交点が最適。",
    difficulty: "medium",
    rounding: "round",
  },
  ...
  // PERT/CPM
  {
    ...
    solution: "4",
    explanation: "EC=(2+4×3+8)/6=3.67、ED=(1+4×2+3)/6=2。合流で最大=3.67→約4。",
    difficulty: "hard",
    unit: "日",
    rounding: "round",
  },
  ...
  // 感度分析 / セールスミックス
  {
    ...
    solution: "52",
    explanation: "元寄与=900→Qb=700,000/900=778。V↑→1,957→寄与=843→Qb=830→差≈52。",
    difficulty: "hard",
    unit: "個",
    rounding: "round",
  },
  {
    ...
    solution: "455",
    explanation: "寄与=A2,000 + B1,200×2=4,400/セット。Q=2,000,000/4,400≈455。",
    difficulty: "medium",
  },
  ...
  // 追加のハード問題
  {
    ...
    solution: "302500",
    explanation: "年金現価係数(12%,5)=3.605。PV=500,000×3.605=1,802,500。NPV=1,802,500-1,500,000=302,500。",
    difficulty: "hard",
    unit: "円",
    rounding: "round",
  },
  {
    ...
    solution: "61",
    explanation: "交点でZ≈60.57→最も近い整数で61（(5,0)=40,(0,7)=42より大）。",
    difficulty: "hard",
    rounding: "round",
  },
  {
...
export const extraQuestions2: Question[] = [
  ...
  { id: "q1033", year: 2022, questionNumber: 14, category: "NPV", content: "I0=700,000、CF=260,000×3年、r=10%。NPV（整数）。", solution: "-53380", explanation: "年金現価係数(10%,3)=2.487。PV=260,000×2.487=646,620。NPV≈-53,380。", difficulty: "hard", unit: "円", rounding: "round" },
  { id: "q1034", year: 2021, questionNumber: 14, category: "NPV", content: "I0=400,000、CF=150,000×4年、r=5%。NPV（整数）。", solution: "131900", explanation: "年金現価係数(5%,4)=3.546。PV=531,900。NPV≈131,900。", difficulty: "medium", unit: "円", rounding: "round" },
  { id: "q1035", year: 2020, questionNumber: 14, category: "在庫", content: "D=8,000、S=1,500、H=40。EOQ（整数）。", solution: "775", explanation: "√(2×8000×1500/40)=√(600,000)=775。", difficulty: "easy", unit: "個", rounding: "round" },
  ...
  { id: "q1040", year: 2022, questionNumber: 14, category: "財務比率", content: "売上総利益率=25%、売上高12,000。売上総利益（最も近い整数）。", solution: "3000", explanation: "12,000×0.25=3,000。", difficulty: "easy", unit: "円", rounding: "round" },
  { id: "q1041", year: 2024, questionNumber: 15, category: "WACC", content: "E=60%、D=40%、Re=11%、Rd=5%、T=30%。WACC（%）。", solution: "8", explanation: "0.6×11%+0.4×5%×0.7=6.6%+1.4%=8.0%。", difficulty: "hard", unit: "%", rounding: "round" },
  { id: "q1042", year: 2023, questionNumber: 15, category: "WACC", content: "E=30%、D=70%、Re=8%、Rd=3%、T=40%。WACC（%）。", solution: "4", explanation: "0.3×8%+0.7×3%×0.6=2.4%+1.26%=3.66%→約4%。", difficulty: "medium", unit: "%", rounding: "round" },
  { id: "q1043", year: 2022, questionNumber: 15, category: "線形計画", content: "Max Z=4X+7Y s.t. 2X+Y≤10, X+3Y≤12。最適Z（整数）。", solution: "34", explanation: "交点(3.6,2.8)でZ=34、端点(0,4)=28,(5,0)=20より交点が最適。", difficulty: "medium", rounding: "round" },
  ...
  { id: "q1048", year: 2024, questionNumber: 15, category: "感度分析", content: "P=3,200,V=2,400,F=500,000。Pが−5%時の損益分岐点数量増分（整数）。", solution: "156", explanation: "寄与800→Qb=625。P↓で寄与640→Qb=781→差≈156。", difficulty: "hard", unit: "個", rounding: "round" },
  { id: "q1049", year: 2023, questionNumber: 15, category: "セールスミックス", content: "A(2,000,1,200)×1、B(3,000,2,700)×2、F=1,500,000。複合損益分岐点（セット）。", solution: "1072", explanation: "寄与=A800 + B300×2=1,400/セット→Q=1,071.4…→約1,072。", difficulty: "medium" },
  ...
  { id: "q1058", year: 2021, questionNumber: 16, category: "WACC", content: "E=50%、D=50%、Re=12%、Rd=6%、T=40%。WACC（%）。", solution: "8", explanation: "0.5×12%+0.5×6%×0.6=6%+1.8%=7.8%→約8%。", difficulty: "hard", unit: "%", rounding: "round" },
  { id: "q1059", year: 2020, questionNumber: 16, category: "NPV", content: "I0=900,000、CF=300,000×4、r=11%。NPV（整数）。", solution: "30900", explanation: "年金現価係数(11%,4)=3.103。PV=930,900。NPV≈30,900。", difficulty: "hard", unit: "円", rounding: "round" },
...
export const extraQuestions3: Question[] = [
  ...
  { id: "q1065", year: 2025, questionNumber: 17, category: "在庫", content: "D=10,000、S=2,000、H=50。EOQ（最も近い整数）。", solution: "894", explanation: "√(2DS/H)=√(2×10000×2000/50)=√(800,000)=894。", difficulty: "medium", unit: "個", rounding: "round" },
  ...
  { id: "q1072", year: 2025, questionNumber: 18, category: "線形計画", content: "Max Z=6X+5Y s.t. 2X+Y≤14, X+2Y≤12。最適Z（整数）。", solution: "49", explanation: "交点(16/3,10/3)でZ≈48.67→最も近い整数で49。", difficulty: "hard", rounding: "round" },
  ...
  { id: "q1076", year: 2025, questionNumber: 18, category: "PERT/CPM", content: "作業A(2,3,8),B(1,3,5)並列→合流。期待工期（最も近い整数）。", solution: "4", explanation: "EA=(2+4×3+8)/6=3.67、EB=(1+4×3+5)/6=3。合流で最大3.67→約4。", difficulty: "hard", unit: "日", rounding: "round" },
  { id: "q1077", year: 2025, questionNumber: 18, category: "感度分析", content: "P=3,000,V=2,250,F=600,000。Vが+4%で損益分岐点数量の増分（最も近い整数）。", solution: "109", explanation: "寄与750→Qb=800。V↑→2,340で寄与660→Qb≈909→差約109。", difficulty: "hard", unit: "個", rounding: "round" },
  { id: "q1078", year: 2025, questionNumber: 18, category: "セールスミックス", content: "A(5,000,3,200)×2、B(2,000,1,400)×1、F=2,400,000。複合損益分岐点（セット）。", solution: "571", explanation: "寄与: A1,800×2=3,600、B600×1=600→合計4,200/セット。Q=2,400,000/4,200≈571。", difficulty: "medium" },
